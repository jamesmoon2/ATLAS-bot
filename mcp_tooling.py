...
ATLAS_TO_PROVIDER_TOOL_NAMES = {
    "atlas__google_calendar__search_events": {
        "claude": "mcp__google-calendar__search-events",
        "codex": "mcp__codex_apps__google_calendar_search_events",
    },
    "atlas__google_calendar__get_profile": {
        "claude": "mcp__google-calendar__list-calendars",
        "codex": "mcp__codex_apps__google_calendar_get_profile",
    },
    "atlas__google_calendar__create_event": {
        "claude": "mcp__google-calendar__create-event",
        "codex": "mcp__codex_apps__google_calendar_create_event",
    },
    "atlas__google_calendar__update_event": {
        "claude": "mcp__google-calendar__update-event",
        "codex": "mcp__codex_apps__google_calendar_update_event",
    },
    "atlas__google_calendar__delete_event": {
        "claude": "mcp__google-calendar__delete-event",
        "codex": "mcp__codex_apps__google_calendar_delete_event",
    },
    "atlas__gmail__list_labels": {
        "claude": "mcp__gmail__list_email_labels",
        "codex": "mcp__codex_apps__gmail_list_labels",
    },
}
...
GOOGLE_CALENDAR_TOOL_PREFIXES = (
    ATLAS_GOOGLE_CALENDAR_PREFIX,
    "mcp__codex_apps__google_calendar_",
    "mcp__google-calendar__",
)

GOOGLE_CALENDAR_PRE_TOOL_MATCHERS = tuple(
    provider_tool
    for atlas_tool in (
        "atlas__google_calendar__create_event",
        "atlas__google_calendar__update_event",
    )
    for provider_tool in ATLAS_TO_PROVIDER_TOOL_NAMES[atlas_tool].values()
)
...
def is_google_calendar_tool_name(tool_name: str) -> bool:
    ...
    return tool_name.startswith(GOOGLE_CALENDAR_TOOL_PREFIXES)
